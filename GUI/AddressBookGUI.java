...
public class AddressBookGUI extends JFrame {
    ...
    public AddressBookGUI(AddressBookController controller, AddressBook addressBook) {
        ...
        {
            if (saveItem.isEnabled() && JOptionPane.YES_OPTION !=
                JOptionPane.showConfirmDialog(this,
                    "Are you sure you want to create a new address book? " +
                        "Any unsaved progress will be lost.", "New Address Book",
        ...
        printItem.addActionListener(e ->
        {
            try {
                ...
                JOptionPane.showMessageDialog(this, "Printing failed: "
                    + ex.getMessage(), "Print", JOptionPane.WARNING_MESSAGE);
            }
        });
        deleteAddressBookItem.setEnabled(false);
        ...
        searchTextField.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void filter() {
                ...
                tableRowSorter.setRowFilter(RowFilter.regexFilter("(?iu)" +
                    Pattern.quote(searchTextField.getText())));
            }
        });
        ...
        panelPanel.add(new JLabel("TIP: You can sort by clicking the column headers"),
